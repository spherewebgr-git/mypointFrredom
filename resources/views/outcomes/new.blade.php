                                        ...
                                        <div class="invoice-item-filed row pt-1" style="width: 95%;">
                                            ...
                                            <div class="col s12 m4 input-field">
                                                <select id="classification_type" name="old[{{$key}}][classification_type]" class="browser-default select-wrapper">
                                                    ...
                                                    <option value="Ε3_101" @if($classification->classification_type == 'Ε3_101') selected @endif>Εμπορεύματα έναρξης [Ε3_101]</option>
                                                    <option value="Ε3_102_001" @if($classification->classification_type == 'Ε3_102_001') selected @endif>Αγορές εμπορευμάτων χρήσης (καθ.ποσό) Χονδρικές [Ε3_102_001]</option>
                                                    <option value="Ε3_102_002" @if($classification->classification_type == 'Ε3_102_002') selected @endif>Αγορές εμπορευμάτων χρήσης (καθαρό ποσό)/Λιανικές [Ε3_102_002]</option>
                                                    <option value="Ε3_102_003" @if($classification->classification_type == 'Ε3_102_003') selected @endif>Αγορές εμπορευμάτων χρήσης (καθαρό ποσό)/Αγαθών του άρθρου 39α παρ.5 του Κώδικα Φ.Π.Α. (ν.2859/2000) [Ε3_102_003]</option>
                                                    <option value="Ε3_102_004" @if($classification->classification_type == 'Ε3_102_004') selected @endif>Αγορές εμπορευμάτων χρήσης (καθαρό ποσό)/Εξωτερικού Ενδοκοινοτικές [Ε3_102_004]</option>
                                                    <option value="Ε3_102_005" @if($classification->classification_type == 'Ε3_102_005') selected @endif>Αγορές εμπορευμάτων χρήσης (καθαρό ποσό)/Εξωτερικού Τρίτες Χώρες [Ε3_102_005]</option>
                                                    <option value="Ε3_102_006" @if($classification->classification_type == 'Ε3_102_006') selected @endif>Αγορές εμπορευμάτων χρήσης (καθαρό ποσό)Λοιπά [Ε3_102_006]</option>
                                                    <option value="Ε3_104" @if($classification->classification_type == 'Ε3_104') selected @endif>Εμπορεύματα λήξης [Ε3_104]</option>
                                                    <option value="Ε3_201" @if($classification->classification_type == 'Ε3_201') selected @endif>Πρώτες ύλες και υλικά έναρξης/Παραγωγή [Ε3_201]</option>
                                                    <option value="E3_202_001" @if($classification->classification_type == 'Ε3_202_001') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Χονδρικές [Ε3_202_001]</option>
                                                    <option value="E3_202_002" @if($classification->classification_type == 'Ε3_202_002') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Λιανικές [Ε3_202_002]</option>
                                                    <option value="E3_202_003" @if($classification->classification_type == 'Ε3_202_003') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Εξωτερικού Ενδοκοινοτικές [Ε3_202_003]</option>
                                                    <option value="E3_202_004" @if($classification->classification_type == 'Ε3_202_004') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Εξωτερικού Τρίτες Χώρες [Ε3_202_004]</option>
                                                    <option value="E3_202_005" @if($classification->classification_type == 'Ε3_202_005') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Λοιπά [Ε3_202_005]</option>
                                                    ...
                                                    <option value="E3_207" @if($classification->classification_type == 'Ε3_207') selected @endif> Προϊόντα και παραγωγή σε εξέλιξη έναρξης/Παραγωγή [Ε3_207]</option>
                                                    <option value="E3_209" @if($classification->classification_type == 'Ε3_209') selected @endif> Προϊόντα και παραγωγή σε εξέλιξη λήξης/Παραγωγή [Ε3_209]</option>
                                                    <option value="E3_301" @if($classification->classification_type == 'Ε3_301') selected @endif> Πρώτες ύλες και υλικά έναρξης/Αγροτική [Ε3_301]</option>
                                                    <option value="E3_302_001" @if($classification->classification_type == 'Ε3_302_001') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Χονδρικές [Ε3_302_001]</option>
                                                    <option value="E3_302_002" @if($classification->classification_type == 'Ε3_302_002') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Λιανικές [Ε3_302_002]</option>
                                                    <option value="E3_302_003" @if($classification->classification_type == 'Ε3_302_003') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Εξωτερικού Ενδοκοινοτικές [Ε3_302_003]</option>
                                                    <option value="E3_302_004" @if($classification->classification_type == 'Ε3_302_004') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Εξωτερικού Τρίτες Χώρες [Ε3_302_004]</option>
                                                    <option value="E3_302_005" @if($classification->classification_type == 'Ε3_302_005') selected @endif> Αγορές πρώτων υλών και υλικών χρήσης (καθαρό ποσό)/Λοιπά [Ε3_302_005]</option>
                                                    <option value="Ε3_581_001" @if($classification->classification_type == 'Ε3_581_001') selected @endif>Παροχές σε εργαζόμενους/Μικτές αποδοχές [Ε3_581_001]</option>
                                                    <option value="Ε3_581_002" @if($classification->classification_type == 'Ε3_581_002') selected @endif>Παροχές σε εργαζόμενους/Εργοδοτικές εισφορές [Ε3_581_002]</option>
                                                    <option value="Ε3_581_003" @if($classification->classification_type == 'Ε3_581_003') selected @endif>Παροχές σε εργαζόμενους/Λοιπές παροχές [Ε3_581_003]</option>
                                                    <option value="E3_582" @if($classification->classification_type == 'Ε3_582') selected @endif> Ζημιές επιμέτρησης περιουσιακών στοιχείων [E3_582]</option>
                                                    <option value="E3_583" @if($classification->classification_type == 'Ε3_583') selected @endif> Χρεωστικές συναλλαγματικές διαφορές [E3_583]</option>
                                                    <option value="E3_584" @if($classification->classification_type == 'Ε3_584') selected @endif> Ζημιές από διάθεση-απόσυρση μη κυκλοφορούντων περιουσιακών στοιχείων [E3_584]</option>
                                                    <option value="Ε3_585_001" @if($classification->classification_type == 'Ε3_585_001') selected @endif>Προμήθειες διαχείρισης ημεδαπής - αλλοδαπής (management fees) [Ε3_585_001]</option>
                                                    <option value="Ε3_585_002" @if($classification->classification_type == 'Ε3_585_002') selected @endif>Δαπάνες από συνδεδεμένες επιχειρήσεις [Ε3_585_002]</option>
                                                    <option value="Ε3_585_003" @if($classification->classification_type == 'Ε3_585_003') selected @endif>Δαπάνες από μη συνεργαζόμενα κράτη ή από κράτη με προνομιακό φορολογικό καθεστώς [Ε3_585_003]</option>
                                                    <option value="Ε3_585_004" @if($classification->classification_type == 'Ε3_585_004') selected @endif>Δαπάνες για ενημερωτικές ημερίδες [Ε3_585_004]</option>
                                                    <option value="Ε3_585_005" @if($classification->classification_type == 'Ε3_585_005') selected @endif>Έξοδα υποδοχής και φιλοξενίας [Ε3_585_005]</option>
                                                    <option value="Ε3_585_006" @if($classification->classification_type == 'Ε3_585_006') selected @endif>Έξοδα ταξιδιών [Ε3_585_006]</option>
                                                    <option value="Ε3_585_007" @if($classification->classification_type == 'Ε3_585_007') selected @endif>Ασφαλιστικές Εισφορές Αυτοαπασχολούμενων [Ε3_585_007]</option>
                                                    <option value="Ε3_585_008" @if($classification->classification_type == 'Ε3_585_008') selected @endif>Έξοδα και προμήθειες παραγγελιοδόχου για λογαριασμό αγροτών [Ε3_585_008]</option>
                                                    <option value="Ε3_585_009" @if($classification->classification_type == 'Ε3_585_009') selected @endif>Λοιπές Αμοιβές για υπηρεσίες ημεδαπής [Ε3_585_009]</option>
                                                    <option value="Ε3_585_010" @if($classification->classification_type == 'Ε3_585_010') selected @endif>Λοιπές Αμοιβές για υπηρεσίες αλλοδαπής [Ε3_585_010]</option>
                                                    <option value="Ε3_585_011" @if($classification->classification_type == 'Ε3_585_011') selected @endif>Ενέργεια [Ε3_585_011]</option>
                                                    <option value="Ε3_585_012" @if($classification->classification_type == 'Ε3_585_012') selected @endif>Ύδρευση [Ε3_585_012]</option>
                                                    <option value="Ε3_585_013" @if($classification->classification_type == 'Ε3_585_013') selected @endif>Τηλεπικοινωνίες [Ε3_585_013]</option>
                                                    <option value="Ε3_585_014" @if($classification->classification_type == 'Ε3_585_014') selected @endif>Ενοίκια [Ε3_585_014]</option>
                                                    <option value="Ε3_585_015" @if($classification->classification_type == 'Ε3_585_015') selected @endif>Διαφήμιση και προβολή [Ε3_585_015]</option>
                                                    <option value="Ε3_585_016" @if($classification->classification_type == 'Ε3_585_016') selected @endif>Λοιπά έξοδα [Ε3_585_016]</option>
                                                    <option value="Ε3_586" @if($classification->classification_type == 'Ε3_586') selected @endif>Χρεωστικοί τόκοι και συναφή έξοδα [Ε3_586]</option>
                                                    <option value="Ε3_587" @if($classification->classification_type == 'Ε3_587') selected @endif>Αποσβέσεις [Ε3_587]</option>
                                                    <option value="Ε3_588" @if($classification->classification_type == 'Ε3_588') selected @endif>Ασυνήθη έξοδα, ζημιές και πρόστιμα [Ε3_588]</option>
                                                    <option value="Ε3_589" @if($classification->classification_type == 'Ε3_589') selected @endif>Προβλέψεις (εκτός από προβλέψεις για το προσωπικό) [Ε3_589]</option>
                                                    ...
                                                    <option value="Ε3_882_001" @if($classification->classification_type == 'Ε3_882_001') selected @endif>Αγορές ενσώματων παγίων χρήσης/Χονδρικές [Ε3_882_001]</option>
                                                    <option value="Ε3_882_002" @if($classification->classification_type == 'Ε3_882_002') selected @endif>Αγορές ενσώματων παγίων χρήσης/Λιανικές [Ε3_882_002]</option>
                                                    <option value="Ε3_882_003" @if($classification->classification_type == 'Ε3_882_003') selected @endif>Αγορές ενσώματων παγίων χρήσης/Εξωτερικού Ενδοκοινοτικές [Ε3_882_003]</option>
                                                    <option value="Ε3_882_004" @if($classification->classification_type == 'Ε3_882_004') selected @endif>Αγορές ενσώματων παγίων χρήσης/Εξωτερικού Τρίτες Χώρες [Ε3_882_004]</option>
                                                    <option value="Ε3_883_001" @if($classification->classification_type == 'Ε3_883_001') selected @endif>Αγορές μη ενσώματων παγίων χρήσης/Χονδρικές [Ε3_883_001]</option>
                                                    <option value="Ε3_883_002" @if($classification->classification_type == 'Ε3_883_002') selected @endif>Αγορές μη ενσώματων παγίων χρήσης/Λιανικές [Ε3_883_002]</option>
                                                    <option value="Ε3_883_003" @if($classification->classification_type == 'Ε3_883_003') selected @endif>Αγορές μη ενσώματων παγίων χρήσης/Εξωτερικού Ενδοκοινοτικές [Ε3_883_003]</option>
                                                    <option value="Ε3_883_004" @if($classification->classification_type == 'Ε3_883_004') selected @endif>Αγορές μη ενσώματων παγίων χρήσης/Εξωτερικού Τρίτες Χώρες [Ε3_883_004]</option>
