...
{{-- page title --}}
@section('title','Λίστα Τιμολογίων - Δελτίων Αποστολής')
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Λίστα Τιμολογίων - Δελτίων Αποστολής</span></h5>
                </div>
