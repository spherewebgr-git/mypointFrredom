...
{{-- page title --}}
@section('title','Λίστα Προμηθευτών Εξωτερικού')
        ...
        <div class="container">
            <div class="row">
                <div class="col s10 m6 l6">
                    <h5 class="breadcrumbs-title mt-0 mb-0"><span>Λίστα Προμηθευτών Εξωτερικού</span></h5>
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="top display-flex  mb-2">
                    ...
                    <div class="actions action-btns display-flex align-items-center">
                        ...
                        <div class="invoice-create-btn">
                            <a href="{{route('foreign-provider.add')}}"
                               class="btn waves-effect waves-light invoice-create border-round z-depth-4">
                                <i class="material-icons">add</i>
                                <span class="hide-on-small-only">Νέος Προμηθευτής Εξωτερικού</span>
                            </a>
                        </div>
                    </div>
                </div>
