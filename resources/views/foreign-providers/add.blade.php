    ...
    <div class="col s12 m12 l12">
        <div id="prefixes" class="card card card-default scrollspy">
            <div class="card-content">
                ...
                <form @if(isset($provider)) action="{{route('foreign-provider.update', ['provider' => $provider])}}" @else action="{{route('foreign-provider.store')}}" @endif method="post">
                    @csrf
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6 m2">
                            <i class="material-icons prefix">map</i>
                            <input id="country" type="text" name="country" @if(isset($provider->city))  value="{{old('country', $provider->country)}}" @endif required>
                    ...
                    <div class="row">
                        <div class="input-field col s6 m3">
                            ...
                            <input id="country_code" type="text" name="country_code" placeholder="π.χ. EL" @if(isset($provider->country_code))  value="{{old('country_code', $provider->country_code)}}" @endif required>
