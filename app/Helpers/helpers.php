...
class helpers
{
    public static function applClasses()
    {
        ...
        $allOptions = [
            ...
            'defaultLanguage'=>array('en'=>'en','fr'=>'fr','de'=>'de','el'=>'el'),
        ...
        $sidenavMain = [
            ...
            'vertical-gradient-menu' => 'sidenav-main nav-expanded nav-lock nav-collapsible gradient-45deg-purple-deep-orange sidenav-gradient ',
        ...
        $navbarMainColor = [
            'vertical-modern-menu' => 'navbar-dark gradient-45deg-blue-grey-blue-grey',
            'vertical-menu-nav-dark' => 'navbar-dark gradient-45deg-blue-grey-blue-grey',
        ...
        $navbarLargeColor = [
            'vertical-modern-menu' => 'gradient-45deg-blue-grey-blue-grey',
        ...
        $mainFooterColor = [
            'vertical-modern-menu' => 'footer-dark gradient-45deg-blue-grey-blue-grey',
            'vertical-menu-nav-dark' => 'footer-dark gradient-45deg-blue-grey-blue-grey',
