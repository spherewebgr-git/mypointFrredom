...
return [
    'custom' => [
        ...
        'defaultLanguage' => 'el', //set your default language Options: en(default),pt,fr,de
        'largeScreenLogo' => 'images/logo/mypoint-logo.png', //we used saparete log image for large screen and small
        'smallScreenLogo' => 'images/logo/mypoint-p.png', // pass the image path here e.g:'images/logo/materialize-logo-color.png' note:(Vertical-menu-nav-dark and horizontal-menu template used a single logo in both small and large screen)
